...
I'm a CS PhD student at the [University of Minnesota-Twin Cities](https://cse.umn.edu/cs), advised by [Prof. Abhishek Chandra](https://www-users.cse.umn.edu/~chandra). My research interest includes Operating & Distributed **Systems**, Computer **Networks**, **Edge** Computing, System-for-**ML**, and **Video** Analytics. I earned my BS in Telecommunications Engineering at [Bandung Insitute of Technology (ITB)](http://itb.ac.id/), advised by [Prof. Hendrawan](https://itb.ac.id/staf/profil/hendrawan). During my undegraduate, I collaborated with [Prof. Junchen Jiang](https://people.cs.uchicago.edu/~junchenj/) and [Prof. Haryadi Gunawi](https://people.cs.uchicago.edu/~haryadi/) of the University of Chicago on a Video Analytics research project.

News
======

- **Aug. 2025:** I started my PhD in Computer Science at UMN Twin Cities
